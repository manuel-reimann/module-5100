...
$errors = array();
$sucess = array();
//empty inputs in form when accessing the page
$usertype = "";
$email = "";
$name = "";
$pwd = "";
...
if (isset($_POST["submit"])) {
    //save variables from superglobal POST
    ...
    //if validation process hasn't been stopped
    else if($check == false){
        createUser($conn, $usertype, $name, $email, $pwd);
        array_push($sucess, 'User registred!');
        //empty fields after sucessfull registration
        $usertype = "";
        $email = "";
        $name = "";
        $pwd = "";
